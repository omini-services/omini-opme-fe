...
import { IFormData } from '@/types/Hospital';
  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      if (result.message === 'Empresa was updated successfully.') {
        handleClose();
        setNotification(
          `Hospital: ${isUpdating && initialData.code} ${isUpdating ? 'atualizado' : 'criado!'} com sucesso`,
        );
      } else {
        handleClose();
        setNotification(
          `Hospital: '${result.code}' nao foi ${isUpdating ? 'atualizado!' : 'criado!'}`,
        );
      }
      ...
      handleClose();
      setNotification(
        `Hospital nao foi ${isUpdating ? 'atualizado!' : 'criado!'}`,
      );
    }
  };
